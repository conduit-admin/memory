---
type: style
kratko: для экрана, не для печати — цвет несёт роль, рисунки в TikZ
---

# Цветной

Стиль конспектов для чтения с экрана, не для печати: цвет несёт роль,
рисунков не жалеют, утверждения не нумеруются.
