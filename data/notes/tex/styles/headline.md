---
type: style
kratko: цветные заголовки блоков, абзацный набор без нумерации, TikZ
---

# Хедлайн

Стиль конспектов. Выжимка из пяти готовых документов — `cursor.tex`, `genfunc.tex`, `integrals.tex`,
